...
const FeaturedCourses = () => {
  const courses = [
    ...
    {
      title: 'Mastering Webflow: Build Stunning Websites Without Code',
      instructor: 'Mohiuddin Sumon',
      role: 'WordPress Developer',
      lessons: '14 Lessons',
      students: '5 Students',
    ...
    {
      title: 'Adobe Premiere Pro Masterclass: Video Editing',
      instructor: 'Mohiuddin Sumon',
      role: 'WordPress Developer',
      lessons: '9 Lessons',
      students: '0 Students',
            ...
            >
              ...
              <div className="p-6">
                <div className="flex justify-between items-center mb-4 text-slate-400 text-sm">
                  <div className="flex items-center"><FileText className="w-4 h-4 mr-1" /> {course.lessons}</div>
                ...
                <div className="flex items-center justify-between mb-6 pb-6 border-b border-slate-700">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="text-white text-sm font-semibold">{course.instructor}</h4>
                      <p className="text-slate-400 text-xs">{course.role}</p>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  {course.price === 'Free' ? (
                    <span className="text-green-400 font-bold text-lg bg-green-400/10 px-3 py-1 rounded">Free</span>
                  ) : (
